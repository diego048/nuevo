        ...
        <div class="row">
          ...
          >
            <NuxtLink
              ...
              class="flex d-flex align-self-stretch card1"
            >
              ...
              <div style="width: 100%">
                <img
                  :src="card.src"
                  v-if="card.ok"
                  style="height: 200px; width: 100%; object-fit: contain; border-style: solid; border-color: rgba(0,0,0,0.15)"
                >
                <img
                  :src="card.src"
                  v-if="card.ok2"
                ...
                <img
                  :src="card.src"
                  v-if="card.ok1"
                  style="background-color: rgb(246, 246, 246); height: 200px; width: 100%; object-fit: contain;border-style: solid; border-color: rgba(0,0,0,0.15)"
                >
                <h5
                  class="text-pre-wrap"
                ...
                <p style="color: rgba(185,185,185,0.8)" align="center"> Más info </p>
              </div>
            </NuxtLink>
          </div>
        </div>
  ...
  export default {
    ...
    setup(){
        useHead({
          ...
          {
            property: "og:image",
            content: "https://mecaluxpe.cdnwm.com/documents/20128/455199/screens.png/7d70a473-c593-d893-14d6-c375cf0de9a7?t=1529911398000&e=png",
          },
          {
            property: "og:url",
            content: "/equipos"
      ...
      return {
        ...
        cards: [
          ...
          },
          {
            ...
            flex1: 4,
            show: false,
            link: "oficinas-modulares",
          },
          {
            id: 6,
            ok: true,
            title: "SISTEMA WMS",
            src: "https://mecaluxpe.cdnwm.com/documents/20128/455199/screens.png/7d70a473-c593-d893-14d6-c375cf0de9a7?t=1529911398000&e=png",
            opti: "https://mecaluxpe.cdnwm.com/documents/20128/455199/screens.png/7d70a473-c593-d893-14d6-c375cf0de9a7?t=1529911398000&e=png",
            flex: 6,
            flex1: 4,
            show: false,
            link: "wms",
