            ...
            >
              ...
              <div style="width: 100%">
                <img
                  :src="card.src"
                  v-if="card.ok"
                  style="height: 200px; width: 100%; object-fit: contain; border-bottom: solid rgba(0,0,0,0.15);"
                >
                <img
                  :src="card.src"
                  v-if="card.ok2"
                ...
                <img
                  :src="card.src"
                  v-if="card.ok1"
                  style="background-color: rgb(246, 246, 246); height: 200px; width: 100%; object-fit: contain;border-bottom: solid rgba(0,0,0,0.15);"
                >
                <h5
                  class="text-pre-wrap"
